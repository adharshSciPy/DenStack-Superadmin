...
const sidebarItems = [
  ...
  { id: "clinics", label: "Clinic Management", icon: Building2, badge: null },
  {
    id: "doctors",
...
const ecommerceItems = [
  { id: "marketplace", label: "Marketplace", icon: Store, badge: null },
  { id: "products", label: "Product Catalog", icon: Package, badge: null },
  { id: "orders", label: "Order Management", icon: ShoppingCart, badge: "12" },
  { id: "vendors", label: "Vendor Management", icon: Users, badge: null },
  { id: "sales", label: "Sales Analytics", icon: TrendingUp, badge: null },
];
...
const systemItems = [
  ...
  { id: "activity", label: "System Activity", icon: Activity, badge: null },
  { id: "settings", label: "Global Settings", icon: Settings, badge: null },
];
...
export function Sidebar({
  ...
  return (
    <div
      className={`sidebar-glass transition-all duration-300 ${collapsed ? "w-16" : "w-64"}`}
      style={{
        display: "flex",
    ...
    >
      ...
      <div
        className="p-4 border-b border-sidebar-border backdrop-blur-sm"
        style={{ flexShrink: 0 }}
      >
      ...
      {/* Navigation — this is the scrollable region */}
      <div
      ...
      >
        ...
        <div>
          ...
          <div className="space-y-1">{ecommerceItems.map(renderMenuItem)}</div>
        </div>
        ...
        <div>
          ...
          <div className="space-y-1">{systemItems.map(renderMenuItem)}</div>
        </div>
      </div>

      {/* Footer — fixed, never shrinks */}
      <div className="p-4 border-t border-border" style={{ flexShrink: 0 }}>
        <div className="flex items-center gap-2">
